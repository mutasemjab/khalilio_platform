        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h4><?php echo e(__('messages.edit_exam')); ?>: <?php echo e($exam->name); ?></h4>
                </div>
...
unset($__errorArgs, $__bag); ?>" 
                                       id="name" name="name" value="<?php echo e(old('name', $exam->name)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                          id="description" name="description" rows="3"><?php echo e(old('description', $exam->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($category->id); ?>" 
                                            <?php echo e(old('category_exam_id', $exam->category_exam_id) == $category->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                                       ...
                                       value="<?php echo e(old('duration_minutes', $exam->duration_minutes)); ?>" min="1" required>
...
unset($__errorArgs, $__bag); ?>" 
                                       ...
                                       value="<?php echo e(old('total_grade', $exam->total_grade)); ?>" min="0" required>
...
unset($__errorArgs, $__bag); ?>" 
                                       ...
                                       value="<?php echo e(old('pass_grade', $exam->pass_grade)); ?>" min="0" required>
...
unset($__errorArgs, $__bag); ?>" 
                                       ...
                                       value="<?php echo e(old('max_attempts', $exam->max_attempts)); ?>" min="1" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-check mt-4">
                                    <input class="form-check-input" type="checkbox" id="randomize_questions" 
                                           ...
                                           <?php echo e(old('randomize_questions', $exam->randomize_questions) ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                                      ...
                                      placeholder="<?php echo e(__('messages.exam_instructions_placeholder')); ?>"><?php echo e(old('instructions', is_array($exam->instructions) ? implode("\n", $exam->instructions) : $exam->instructions)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <?php echo e(__('messages.update_exam')); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\platform\resources\views/admin/exams/edit.blade.php ENDPATH**/ ?>