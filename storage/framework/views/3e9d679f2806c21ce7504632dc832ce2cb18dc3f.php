...
<div class="exam-taking-section" style="display: block;">
    ...
    <div class="exam-header-bar">
        <div class="exam-info">
            <h2 class="exam-name"><?php echo e($attempt->exam->name); ?></h2>
            <div class="question-progress">
                السؤال <?php echo e($progress['current']); ?> من <?php echo e($progress['total']); ?>

                <div class="progress-bar">
                    <div class="progress-fill" style="width: <?php echo e($progress['percentage']); ?>%"></div>
                </div>
            </div>
        </div>
        ...
        <div class="question-card">
            <div class="question-header">
                <div class="question-type">
                    ...
                    <?php echo e($currentQuestion->type_name); ?>

                </div>
                <div class="question-grade">
                    <?php echo e($currentQuestion->grade); ?> نقطة
                </div>
            </div>

            <div class="question-content">
                <?php if($currentQuestion->question_image): ?>
                    <div class="question-image">
                        <img src="<?php echo e($currentQuestion->question_image_url); ?>" alt="صورة السؤال" />
                    </div>
                <?php endif; ?>
                ...
                <div class="answer-area">
                    <?php if($currentQuestion->type == 'multiple_choice'): ?>
                        <?php echo $__env->make('includes.question-types.multiple-choice', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <?php elseif($currentQuestion->type == 'true_false'): ?>
                        <?php echo $__env->make('includes.question-types.true-false', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <?php elseif($currentQuestion->type == 'essay'): ?>
                        <?php echo $__env->make('includes.question-types.essay', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <?php elseif($currentQuestion->type == 'fill_blank'): ?>
                        <?php echo $__env->make('includes.question-types.fill-blank', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <?php endif; ?>
                </div>
            </div>
        </div>
    ...
    <div class="exam-navigation">
        <div class="nav-buttons">
            <?php if($currentQuestionIndex > 0): ?>
                <button class="btn-nav btn-prev" onclick="navigateQuestion(<?php echo e($currentQuestionIndex - 1); ?>)">
                    <i class="fas fa-chevron-right"></i>
                    السؤال السابق
                </button>
            <?php endif; ?>

            <?php if($currentQuestionIndex < $questions->count() - 1): ?>
                <button class="btn-nav btn-next" onclick="navigateQuestion(<?php echo e($currentQuestionIndex + 1); ?>)">
                    السؤال التالي
        ...
        <div class="question-navigator">
            ...
            <div class="questions-grid">
                <?php $__currentLoopData = $questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <button class="question-btn <?php echo e($index == $currentQuestionIndex ? 'active' : ''); ?>" 
                            onclick="navigateQuestion(<?php echo e($index); ?>)"
    ...
    <div id="submitModal" class="exam-modal">
        <div class="modal-content">
            ...
            <div class="modal-actions">
                ...
                <form action="<?php echo e(route('exam.submit', [$attempt->exam_id, $attempt->id])); ?>" method="POST" style="display: inline;">
                    <?php echo csrf_field(); ?>
...
const examId = <?php echo e($attempt->exam_id); ?>;
let currentQuestionId = <?php echo e($currentQuestion->id); ?>;
const totalQuestions = <?php echo e($questions->count()); ?>;
let currentQuestionIndex = <?php echo e($currentQuestionIndex); ?>;
let timeRemaining = 0;
let timerInterval;
let autoSaveTimeout;
...
const routes = {
    timeRemaining: "<?php echo e(route('exam.time-remaining', $attempt->id)); ?>",
    saveAnswer: "<?php echo e(route('exam.save-answer', [$attempt->exam_id, $attempt->id])); ?>",
    takeExam: "<?php echo e(route('exam.take', [$attempt->exam_id, $attempt->id])); ?>"
};
...
function loadPreviousAnswer() {
    <?php if($previousAnswer && $previousAnswer->user_answer): ?>
        const answer = <?php echo json_encode($previousAnswer->user_answer, 15, 512) ?>;
        const questionType = getCurrentQuestionType();
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\platform\resources\views/sections/exam-taking.blade.php ENDPATH**/ ?>