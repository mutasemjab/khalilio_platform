        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header">
                    <h4><?php echo e(__('messages.add_question')); ?>: <?php echo e($exam->name); ?></h4>
                </div>

                <div class="card-body">
                    <form action="<?php echo e(route('questions.store', $exam)); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    <option value="fill_blank" <?php echo e(old('type') == 'fill_blank' ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                                       id="grade" name="grade" value="<?php echo e(old('grade', 1)); ?>" min="0.1" required>
...
unset($__errorArgs, $__bag); ?>" 
                                       id="order" name="order" value="<?php echo e(old('order', $nextOrder)); ?>" min="1" required>
...
unset($__errorArgs, $__bag); ?>" 
                                      id="question_text" name="question_text" rows="4" required><?php echo e(old('question_text')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                      ...
                                      placeholder="<?php echo e(__('messages.explanation_placeholder')); ?>"><?php echo e(old('explanation')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="<?php echo e(route('questions.index', $exam)); ?>" class="btn btn-secondary">
                                <?php echo e(__('messages.cancel')); ?>

                            </a>
                            <button type="submit" class="btn btn-primary">
                                <?php echo e(__('messages.create_question')); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\platform\resources\views/admin/questions/create.blade.php ENDPATH**/ ?>